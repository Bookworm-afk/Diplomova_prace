...
| [I](./Priloha_I_prehled_kodu) | Tabulkový přehled hlavních Python a Reliance skriptů použitých v řešení | [`prehled_python_reliance_scriptu.xlsx`](./Priloha_I_prehled_kodu/prehled_python_reliance_scriptu.xlsx) |
